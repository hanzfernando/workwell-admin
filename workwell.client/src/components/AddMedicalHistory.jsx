...
import { addMedicalHistory } from '../services/medicalHistoryService';

const AddMedicalHistory = ({ patient, onClose, refreshHistory }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            refreshHistory(); // Refresh the history after adding
            onClose();
        } catch (error) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-3xl">
                <h3 className="text-xl font-semibold mb-4">Add Medical History</h3>
